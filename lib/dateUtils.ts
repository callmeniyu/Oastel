...
export const formatDateForServer = formatDateAsMYT;
...
export const createLocalDate = parseDateStringAsMYT;
...
/**
 * Check if a date string represents today in Malaysian timezone
 * 
 * @param dateString - Date string in YYYY-MM-DD format
...
export function isToday(dateString: string): boolean {
  ...
  return dateString === formatDateAsMYT(today);
}

/**
 * Check if a date string represents a future date in Malaysian timezone
 * 
 * @param dateString - Date string in YYYY-MM-DD format
...
export function isFutureDate(dateString: string): boolean {
  const today = getMalaysianNow();
  const todayString = formatDateAsMYT(today);
  return dateString > todayString;
}

/**
 * Get formatted date string for today in Malaysian timezone
 * 
 * @returns Today's date in YYYY-MM-DD format
 */
export function getTodayString(): string {
  return formatDateAsMYT(getMalaysianNow());
}
