      ...
      const matchTransport =
        ...
        transports.some((t) => {
          ...
          switch (transportLower) {
            ...
            default:
              // Handle "Private - {vehicle}" format
              if (t.startsWith("Private - ")) {
                const vehicleName = t.substring(10); // Remove "Private - " prefix
                return (
                  transferTypeLower === "private" &&
                  transfer.vehicle?.toLowerCase() === vehicleName.toLowerCase()
                );
              }
              return false;
          }
      ...
      <div className="relative h-96 md:h-[100vh] pt-16 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center text-white px-4">
          ...
          <p className="mt-3 max-w-xl text-base md:text-lg font-poppins">
            Browse our van and boat transfer tickets to and from Cameron
            Highlands, Taman Negara, Kuala Besut, and more. Comfortable rides,
            trusted service.
          </p>
        </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredTransfers.length === 0 ? (
                      <div className="col-span-full text-center text-desc_gray mt-4 text-sm">
                        ...
                        />
                        <p>
                          No transfers found for "{searchTerm}". Try different
                          keywords.
                        </p>
                      </div>
                    ) : (
