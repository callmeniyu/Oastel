...
export default async function TransferDetailPage({ params }: TransferDetailPageProps) {
    ...
    try {
        ...
        if (response.success) {
            othertransfers = response.data.filter((transfer) => transfer.slug !== slug).slice(0, 4)
        }
    } catch (error) {
                    ...
                    <div className="space-y-6 mt-6">
                        ...
                        <div className="bg-white border rounded-md p-4 shadow-sm">
                            ...
                            <div
                                ...
                                dangerouslySetInnerHTML={{ __html: transferDetails.details.about }}
                            />
                        </div>
                        ...
                        <div className="bg-white border rounded-md p-4 shadow-sm">
                            ...
                            <div
                                className="prose max-w-none text-sm text-desc_gray mt-2"
                                dangerouslySetInnerHTML={{ __html: transferDetails.details.itinerary }}
                            />
                        </div>
                        ...
                        <div className="bg-white border rounded-md p-4 shadow-sm">
                            <div className="flex gap-2 items-center mb-2">
                                ...
                                <h5 className="font-semibold text-primary_green">Pickup Location</h5>
                                                        ...
                                                        <div
                                className="prose max-w-none text-sm text-desc_gray mt-2"
                                dangerouslySetInnerHTML={{ __html: transferDetails.details.pickupLocations }}
                            />
                        </div>
                        ...
                        <div className="bg-white border rounded-md p-4 shadow-sm">
                            <div className="flex gap-2 items-center mb-2">
                                ...
                                <h5 className="font-semibold text-primary_green">Note</h5>
                                                        ...
                                                        <div
                                className="prose max-w-none text-sm text-desc_gray mt-2"
                                dangerouslySetInnerHTML={{ __html: transferDetails.details.note || "No additional notes provided." }}
                            />
                        </div>
                    </div>
                </div>
