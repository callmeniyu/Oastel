    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={confirmationRef}>
          ...
          <div className="mt-8 relative overflow-hidden bg-gradient-to-br from-emerald-600 via-green-500 to-teal-600 rounded-3xl shadow-2xl border border-white/20">
            {/* Background Pattern */}
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-white">
                        <div className="font-semibold">Share your review</div>
