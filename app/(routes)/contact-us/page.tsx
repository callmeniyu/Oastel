...
import { FaWhatsapp, FaInstagram, FaFacebook, FaYoutube, FaTwitter, FaTiktok, FaTelegram, FaEnvelope } from "react-icons/fa"
        ...
        <div className="min-h-screen bg-white font-poppins">
            ...
            <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                        <div className="flex items-center mb-4 ">
                            ...
                            <h3 className="text-xl font-semibold text-title_black">WhatsApp</h3>
                        </div>
                        <p className="text-desc_gray mb-4">Chat with us directly for quick responses</p>
                        <Link
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border transform transition-transform hover:shadow-lg">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="text-xl font-semibold text-title_black">Instagram</h3>
                        </div>
                        <p className="text-desc_gray mb-4">Follow us and send DMs for the latest updates</p>
                        <Link
                ...
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold text-primary_green mb-4">Our Socials</h2>
                ...
                <h2 id="feedback" className="text-3xl py-4 pt-8 font-bold text-primary_green mb-6 text-center">
...
function SocialIcon({ icon, url, label, color }: { icon: React.ReactNode; url: string; label: string; color: string }) {
    return (
        <Link
            href={url}
            target="_blank"
