...
export default function NotFound() {
  ...
  useEffect(() => {
    // Automatically redirect to homepage after 3 seconds for undefined routes
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex flex-col items-center justify-center p-4 font-poppins relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-6xl md:text-8xl font-extrabold text-primary_green mb-2 tracking-tight">
              404
            </h1>
            <h2 className="text-3xl md:text-4xl font-bold text-title_black mb-4">
              Oops! Page Not Found
            </h2>
          </div>
          ...
          <p className="text-desc_gray text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            ...
            your way back to amazing adventures.
          </p>

          <p className="text-primary_green text-sm font-medium">
