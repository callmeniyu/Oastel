        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                    <Link href="/" className="text-2xl font-bold text-primary_green font-poppins hover:text-primary_green/90 transition-colors">
                        Oastel
                    </Link>
                    <button 
                        onClick={onClose}
                    ...
                    <div className="space-y-1 px-4">
                        ...
                        <div className="mb-2">
                            <button
                                ...
                                className="flex items-center justify-between w-full px-3 py-3 rounded-lg hover:bg-primary_green/5 transition-colors"
                            >
                                <span className="font-medium text-title_black">Help & Support</span>
