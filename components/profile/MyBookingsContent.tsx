...
export default function MyBookingsContent() {
  ...
  const bookings: Booking[] = [
    {
      ...
      children: 1,
      price: 449,
      status: isTripCompleted("2026-11-15", "08:30 AM")
        ? "completed"
        : "upcoming",
      details: {
        duration: "8 hours",
    ...
    },
    {
      ...
      children: 1,
      price: 120,
      status: isTripCompleted("2028-11-20", "02:00 PM")
        ? "completed"
        : "upcoming",
      details: {
    ...
    },
    {
      ...
      children: 1,
      price: 299,
      status: isTripCompleted("2022-11-20", "02:00 PM")
        ? "completed"
        : "upcoming",
      details: {
    ...
    },
    {
      ...
      children: 1,
      price: 150,
      status: isTripCompleted("2022-07-10", "01:00 PM")
        ? "completed"
        : "upcoming",
      details: {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "upcoming":
        return (
          <span className="bg-primary_green/10 text-primary_green px-3 py-1 rounded-full text-sm">
            Upcoming
          </span>
        );
      case "completed":
  ...
  return (
    <div className="max-w-6xl mx-auto p-4p md:p-6 font-poppins">
      <h1 className="text-2xl md:text-3xl font-bold text-title_black mb-6">
        My Bookings
      </h1>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-5 md:w-2/3">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <p className="text-lg font-medium text-primary_green">
                      RM {booking.price}
                    </p>
                  </div>
        ...
        {activeTab === "upcoming" && upcomingBookings.length === 0 && (
          <div className="text-center py-12 bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-desc_gray mb-6">
              Your upcoming tours and transfers will appear here
            </p>
            <a
              href="/tours"
