    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <Image src="/images/hero.jpg" alt="Cameron Highlands" fill className="object-cover" priority />
                    ...
                    {bookingOptions.map((option, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center text-white z-10">
                                ...
                                <h3 className="text-2xl font-bold mt-4 drop-shadow-sm">{option.title}</h3>
                                <p className="mt-2 opacity-90 drop-shadow-sm">{option.description}</p>
